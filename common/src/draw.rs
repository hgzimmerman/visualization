...
pub fn rainbow() -> Gradient<Rgba> {
    ...
    Gradient::with_domain(colors.clone())
}

pub fn colored_lines_no_corners(draw: &Draw, points: &[Point2], thickness: f32, skip: usize, gradient: Gradient<Rgba>) {
    let len = points.len();
