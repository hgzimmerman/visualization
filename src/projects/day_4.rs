...
impl Model {
    ...
    pub fn update(app: &App, model: &mut Model, _update: Update) {
        ...
        if model.frame_counter.0 % SHOULD_ADD == 0 {
            ...
            let colors = [
                Rgba::new_u8(0xe6, 0x26, 0x1f, 0x10), // RED
                Rgba::new_u8(0xeb, 0x75, 0x32, 0x10),
                Rgba::new_u8(0xf7, 0xd0, 0x38, 0x10), // f7d038
                Rgba::new_u8(0xa3, 0xe0, 0x48, 0x10), // a3e048
                Rgba::new_u8(0x49, 0xda, 0x9a, 0x10), // 49da9a
                Rgba::new_u8(0x34, 0xbb, 0xe6, 0x10), // 34bbe6
                Rgba::new_u8(0x43, 0x55, 0xdb, 0x10), // 4355db
                Rgba::new_u8(0xd2, 0x3b, 0xe7, 0x10), // d23be7
            ];
